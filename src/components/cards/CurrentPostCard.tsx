...
const CurrentPostCard = (props:{currentPost:string, action:Function}) => {
  return (
    <div className='p-4 rounded-xl bg-white flex flex-col justify-center gap-2'>
        ...
        <button type="button" onClick={()=>{props.action(props.currentPost)}} className={`w-full p-2 text-white text-[20px] bg-primary2 hover:bg-primary1 rounded-full drop-shadow-lg shadow-lg`}>
            Register
        </button>
    </div>
  )
