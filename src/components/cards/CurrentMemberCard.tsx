...
function CurrentMemberCard(props:{info:BureauMemberType}) {
  return (
    <div className='w-[300px] h-[300px] py-4 bg-white rounded-lg hover:drop-shadow-lg flex flex-col gap-2 justify-between items-center text-center text-primary4'>
