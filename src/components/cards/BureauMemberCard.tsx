...
const BureauMemberCard = (props:{data:DefaultBureau,active:boolean}) => {
  return (
    <div className={`min-w-[200px] min-h-[220px] py-4 px-2 snap-start snap-always ${props.active?'bg-primary3 text-white':'bg-white'} rounded-lg hover:drop-shadow-lg flex flex-col justify-between items-center text-center text-primary4`}>
