...
function Footer() {
  return (
    <footer className={`w-full bg-white border-t-2 border-grayToneStroke py-2 px-10 flex flex-row justify-between text-primary4 items-center`}>
        ...
        <Image src='/assets/img/enspy/logo.png' alt="Club GI" width={500} height={500} className="w-[80px] aspect-square drop-shadow-2xl"/>
    </footer>
  )
}
