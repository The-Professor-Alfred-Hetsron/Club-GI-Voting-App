...
export default function Auth() {
    ...
    return (
      <main className="h-screen w-screen bg-[url('/assets/img/enspy/img6.jpg')] bg-cover bg-no-repeat bg-center flex flex-col items-center justify-center overflow-hidden">

        <div className="w-screen h-screen relative bg-primary1Trans flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className={`w-[60%] h-[70%] z-10 login ${isSignUp && 'right-panel-active'} relative overflow-hidden drop-shadow-3xl shadow-xl rounded-2xl flex flex-row`}>
